...
export default function Home({ children }: any) {
  ...
  return (
    <div className="container mx-auto text-gray-800 flex flex-col justify-center items-center">
      <div className="w-full h-full text-center mt-24 space-y-3">
        ...
        <h3 className="text-xl text-gray-800 font-semibold">Elevate Your Development Workflow with Tailwind CSS for Dynamic Component Libraries.</h3>
      </div>
      <div className="space-x-4 mt-7">
        <Link href={"/components"} className="py-4 px-7 bg-[#34e7e4] rounded-lg text-white">
        Get Started
        </Link>
